...
public class LaunchPadSkill extends Skill {
	...
	/*
	 * @setter ("buttonPressed" ) public void setButtonPressed(String s) { if(LaunchPadEventLayer.pressedButton!=null){
	 * LaunchPadEventLayer.client.setButtonLight(LaunchPadEventLayer.pressedButton, Color.RED,
	...
	/*
	 * @setter ("padPressed" ) public void setPadPressed(ILocation l) { if(LaunchPadEventLayer.pressedPad!=null){
