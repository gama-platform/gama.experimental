...
* Name: mpi controler
* Author: LG
* Description: Controller of MovingAgent
*/
model controler

import "MovingAgent.gaml" as pp
...
global skills:[MPI_Network] 
{
    ...
    {
    	create pp.movingExp; // todo set nb of agent random
    }
    ...
    action finalize // trouver un moyen d'exec le finalize ou bien de détecter la fin de sous-modèle 
    {
    	...
    	list<generic_species> generic_species_list <- pp.movingExp[0].get_generic_species_list_in_area(stripStart, stripEnd);
