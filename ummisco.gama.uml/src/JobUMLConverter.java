...
public class JobUMLConverter extends WorkspaceJob 
{
	WrappedGamaFile modelFile;
	String directory;
	public JobUMLConverter(WrappedGamaFile modelFile, String directory) {
	...
	public IStatus runInWorkspace(IProgressMonitor monitor) throws CoreException {
		GamlToUMLConverter gamlConverter = new GamlToUMLConverter(this.modelFile);
