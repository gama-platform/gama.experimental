...
public class StorableData {
	...
	public IMap varmap_reverse;
	public IMap<Integer, String> varmap; // varname-colnb map //liste des variables
	public IMap<Integer, String> numvarmap; // varname-colnb map for numerical variables //listes des variables
											// numériques
	public IMap<Integer, String> qualivarmap; // varname-colnb map the rest
	...
	public IMap<Integer, String> getVarmap() {
		return varmap;
	}

	public void setVarmap(final IMap<Integer, String> varmap) {
		this.varmap = varmap;
	}

	public IMap<Integer, String> getNumvarmap() {
		return numvarmap;
	}

	public void setNumvarmap(final IMap<Integer, String> numvarmap) {
		this.numvarmap = numvarmap;
	}

	public IMap<Integer, String> getQualivarmap() {
		return qualivarmap;
	}

	public void setQualivarmap(final IMap<Integer, String> qualivarmap) {
	...
	public void init(final IScope scope) {
		...
		varmap = GamaMapFactory.create(Types.INT, Types.STRING);
		numvarmap = GamaMapFactory.create(Types.INT, Types.STRING);
		qualivarmap = GamaMapFactory.create(Types.INT, Types.STRING);
