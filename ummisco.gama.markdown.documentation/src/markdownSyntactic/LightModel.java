 ...
 * Date : 19 Dec 2017
 * Class used to have few information on a model without using too much memory
 */
public class LightModel {
	 ...
	 */
	public Map<String, String> speciesLink = new HashMap<String,String>();
	/**
	 * Variable representing all the experiments and the link to the documentation files that will present them
	 */
	public Map<String, String> experimentsLink = new HashMap<String,String>();
	 ...
	 * @param aUri {@code URI} the URI used to get the contents
	 */
	public LightModel(URI aUri)
	{
