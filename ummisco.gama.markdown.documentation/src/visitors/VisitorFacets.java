 ...
 * Date : 19 Dec 2017
 * Class representing the visitor of IExpressionDescription representing Facets defined in GAML. This visitor
 * will generate the Markdown text for a visited IExpressionDescription for the Documentation
 */
public class VisitorFacets extends FacetVisitor{
	/**
	 ...
	 */
	public VisitorFacets(Map<String, String> linkSpecies,Map<String, String> linkExperiments)
	{
	 ...
	 * @param exp {@code IExpressionDescription}, the IExpressionDescription representing facets that will be used to generate the markdown code
	 */
