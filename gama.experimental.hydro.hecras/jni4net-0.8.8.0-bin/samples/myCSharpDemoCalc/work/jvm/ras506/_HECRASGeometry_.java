...
public final class _HECRASGeometry_ {
    
    //<generated-static>
    private static system.Type staticType;
    
    public static system.Type typeof() {
        return ras506._HECRASGeometry_.staticType;
    }
    
    private static void InitJNI(net.sf.jni4net.inj.INJEnv env, system.Type staticType) {
        ras506._HECRASGeometry_.staticType = staticType;
    }
    //</generated-static>
}
...
class ___HECRASGeometry extends system.Object implements ras506._HECRASGeometry {
    
    protected ___HECRASGeometry(net.sf.jni4net.inj.INJEnv __env, long __handle) {
