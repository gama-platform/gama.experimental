...
public final class _HECRASController_ {
    
    //<generated-static>
    private static system.Type staticType;
    
    public static system.Type typeof() {
        return ras506._HECRASController_.staticType;
    }
    
    private static void InitJNI(net.sf.jni4net.inj.INJEnv env, system.Type staticType) {
        ras506._HECRASController_.staticType = staticType;
    }
    //</generated-static>
}
...
class ___HECRASController extends system.Object implements ras506._HECRASController {
    
    protected ___HECRASController(net.sf.jni4net.inj.INJEnv __env, long __handle) {
