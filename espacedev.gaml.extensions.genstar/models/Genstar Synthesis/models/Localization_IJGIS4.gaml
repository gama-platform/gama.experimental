...
global {
	...
	init {
		...
		localize species: people nests: residential_building nest_attribute: "nest" max_dist_loc: 500.0 step_dist_loc: 100.0 distribution: "area" 
		...
		write sample(length(children));
		link entities: children nests: school nest_attribute: "my_school" distribution: "gravity";
	}
} 
