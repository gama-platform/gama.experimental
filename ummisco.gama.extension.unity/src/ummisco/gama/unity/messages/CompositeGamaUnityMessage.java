...
public class CompositeGamaUnityMessage extends GamaUnityMessage {
	...
	/*
	 * public CompositeGamaUnityMessage(IScope scope, Object sender, Object
	 * receivers, Object content) throws GamaRuntimeException { super(scope, sender,
	 * receivers, content); this.setUnread(true); deserializeContent=null; }
	 */
	...
	public CompositeGamaUnityMessage(IScope scope, GamaUnityMessage message) {
		super(scope, message.getSender(), message.getReceivers(), message.getUnityAction(), message.getUnityObject(),
				(Map<?, ?>) message.getUnityAttribute(), message.getUnityTopic(), message.getContents(scope));
	...
	/*
	 * private CompositeGamaUnityMessage(IScope scope, Object sender, Object
	 * receivers, Object content,Object deserializeContent,int timeStamp) {
	 * super(scope, sender, receivers, content); this.emissionTimeStamp = timeStamp;
