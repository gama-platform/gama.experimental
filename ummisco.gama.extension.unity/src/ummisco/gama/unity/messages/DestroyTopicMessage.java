...
public class DestroyTopicMessage extends GamaMessage {
	...
	@getter(DestroyTopicMessage.OBJECT_NAME)
	public Object getObjectName() {
		return objectName;
	}

	@setter(DestroyTopicMessage.OBJECT_NAME)
	...
	@Override
	public DestroyTopicMessage copy(final IScope scope) throws GamaRuntimeException {
		return new DestroyTopicMessage(scope, getSender(), getReceivers(), getObjectName(), getContents(scope));
	}
