...
public class UnitySkill extends NetworkSkill {
	...
	public static MQTTUnityConnector connector;
	...
	public void connectToServer(final IScope scope) throws GamaRuntimeException {
		...
		final Integer port =
				scope.hasArg(INetworkSkill.PORT) ? (Integer) scope.getArg(INetworkSkill.PORT, IType.INT) : SERVER_PORT;
	...
	public static synchronized boolean isNotificationTrue(final IScope scope, final String notificationId) {
