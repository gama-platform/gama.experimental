...
public class TestSoilData {
	...
	public static void main(String[] args) {
		SoilFactory soil = new SoilFactory();
		...
		Apsf f =soil.compileAndBuild();
		ArrayList<Template> md = f.getAPSF().getTemplate().getAllSubTemplate();
		
		
		SoilLocation s = new SoilLocation(41,26,89,3,f);
		
		Particle p =f.getParticleAtLocation(null, s);
